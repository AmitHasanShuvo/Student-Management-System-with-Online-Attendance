...
About us</a>
          <ul class="dropdown-menu">
            <li><a href="#" style="color:black;font-weight:normal">About Us</a></li>
          </ul>
        </li>
      </ul>
    </div><!-- /.navbar-collapse -->
    ...
    <div class="col-sm-2">
       <br><br>
        <ul id="side_Menu" class="nav nav-pills nav-stacked">
           ...
           <li><a href="attent.php"><span class="glyphicon glyphicon-tags"></span>&nbsp;&nbsp;Attendance</a></li>
           <li><a href="viewattent.php"><span class="glyphicon glyphicon-tags"></span>&nbsp;&nbsp;View Attendance</a></li>
           ...
           <li><a href="notice.php"><span class="glyphicon glyphicon-equalizer"></span>&nbsp;&nbsp;Add Notice</a></li>
           <li><a href="noticelist.php"><span class="glyphicon glyphicon-equalizer"></span>&nbsp;&nbsp;Notice List</a></li>
